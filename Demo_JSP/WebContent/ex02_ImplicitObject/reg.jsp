...
<body>
	...
	<hr>
	<%
		request.setAttribute("password2", "999999");
		int number = -1;
	...
	%>
	<form name="regForm" action="/Demo_JSP/ex02_ImplicitObject/request.jsp" method="post">
		<table>
			<tr>
				<td>用户名：</td>
				<td>
	...
	<br>
	<br>
	<a href="/Demo_JSP/ex02_ImplicitObject/request.jsp?username=李四">测试URL传参数</a>
