...
<body>
	...
	<br />
	<%
		pageContext.setAttribute("name", "Johnny"); //map
	%>
	${pageScope.name}
	<br />
	...
	<br />
	<%
		request.setAttribute("name", "Nick"); //map
	%>
	${requestScope.name}
	<br />
	...
	<br />
	<%
		session.setAttribute("user", "user001"); //map
	%>
	${sessionScope.user}
	<br />
	...
	<br />
	<%
		application.setAttribute("user", "user002"); //map
	%>
