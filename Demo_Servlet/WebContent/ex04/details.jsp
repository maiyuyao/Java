...
<%@ page import="ex04_mvc.entity.Items"%>
<%@ page import="ex04_mvc.dao.ItemsDAO"%>
<%
...
<script type="text/javascript">
      ...
      { 
         ...
         J.dialog.get({id: 'haoyue_creat',title: '购物成功',width: 600,height:400, link: '<%=path%>/ex04/CartServlet?id=' + id + '&num=' + num
					+ '&action=add',
			cover : true
		});
	}
...
<body>
	<h1>商品详情</h1>
	<a href="ex04/index.jsp">首页</a>
	>>
	<a href="ex04/index.jsp">商品列表</a>
	<hr>
	<center>
			...
			<tr>
				...
				<td width="70%" valign="top">
					...
					<div id="cart">
						...
						<a href="ex04/CartServlet?action=show">
				...
				<td width="30%" bgcolor="#EEE" align="center">
					<br>
					<b>
						<font color="#FF7F00">您浏览过的商品</font>
					</b>
					<br>
					<!-- 循环开始 -->
					<%
					...
					<div>
						<dl>
							<dt>
								<a href="ex04/details.jsp?id=<%=i.getId()%>">
