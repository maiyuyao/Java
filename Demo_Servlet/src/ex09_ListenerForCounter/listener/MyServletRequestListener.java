package ex09_ListenerForCounter.listener;
...
import ex09_ListenerForCounter.entity.User;
import ex09_ListenerForCounter.util.SessionUtil;

@WebListener
public class MyServletRequestListener implements ServletRequestListener {

	private ArrayList<User> userList;//在线用户
