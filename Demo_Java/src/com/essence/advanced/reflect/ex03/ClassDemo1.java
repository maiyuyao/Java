...
public class ClassDemo1 {
	public static void main(String[] args) {
		...
		// 官网阐述 c1 ,c2 表示了Foo类的类类型(class type)， 万事万物皆对象， 类也是对象.
		// c1 ,c2是Class类的实例对象，这个对象我们称为该类的类类型
		...
		Class c3 = null;
		try {
			c3 = Class.forName("yao.concept.reflect.Foo");
		...
		try {
			Foo foo = (Foo) c3.newInstance();// 需要有无参数的构造方法
			foo.print();
